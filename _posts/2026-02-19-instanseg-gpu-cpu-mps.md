...
## Portée précise
- Référence article: `instanseg-gpu-cpu-mps`
- Périmètre: la segmentation cellulaire et la quantification d'objets.
- Axe technique dominant: **instanseg** (focus complémentaire: gpu, cpu, mps).
...
![Illustration - InstanSeg : comparaison CPU, GPU et MPS](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope3.jpg)
