---
title: "CytoMAP : contrôle qualité des données d'entrée"
...
# CytoMAP : contrôle qualité des données d'entrée

## Portée précise
- Référence article: `cluster-cytomap-qc-donnees`
- Périmètre: le clustering et l'analyse spatiale de populations.
- Axe technique dominant: **cytomap** (focus complémentaire: cluster, qc, donnees).
...
![Illustration - CytoMAP : contrôle qualité des données d'entrée](https://commons.wikimedia.org/wiki/Special:FilePath/Cell-universe.jpg)
