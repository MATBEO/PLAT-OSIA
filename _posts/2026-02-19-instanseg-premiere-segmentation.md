...
## Portée précise
- Référence article: `instanseg-premiere-segmentation`
- Périmètre: la segmentation cellulaire et la quantification d'objets.
- Axe technique dominant: **instanseg** (focus complémentaire: premiere, segmentation).
...
![Illustration - InstanSeg : première segmentation cellule + noyau](https://commons.wikimedia.org/wiki/Special:FilePath/Red%20Fluorescence%20Microscopy.jpg)
