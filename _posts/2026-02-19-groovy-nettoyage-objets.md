---
title: "Groovy : nettoyer les objets avant export"
...
# Groovy : nettoyer les objets avant export

## Portée précise
- Référence article: `groovy-nettoyage-objets`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **groovy** (focus complémentaire: nettoyage, objets).
...
![Illustration - Groovy : nettoyer les objets avant export](https://commons.wikimedia.org/wiki/Special:FilePath/Dividing%20Cell%20Fluorescence.jpg)
