---
title: "QC : protocole de relecture des annotations"
...
# QC : protocole de relecture des annotations

## Portée précise
- Référence article: `qc-relecture-annotations`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **qc** (focus complémentaire: relecture, annotations).
