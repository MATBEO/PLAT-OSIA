...
## Portée précise
- Référence article: `python-geojson-lire-ecrire`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **python** (focus complémentaire: geojson, lire, ecrire).
...
![Illustration - Python : lire et écrire un GeoJSON](https://commons.wikimedia.org/wiki/Special:FilePath/Cell-universe.jpg)
