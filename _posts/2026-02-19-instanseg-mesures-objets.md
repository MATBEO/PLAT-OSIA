---
title: "InstanSeg : générer et exploiter les mesures d'objets"
...
# InstanSeg : générer et exploiter les mesures d'objets

## Portée précise
- Référence article: `instanseg-mesures-objets`
- Périmètre: la segmentation cellulaire et la quantification d'objets.
- Axe technique dominant: **instanseg** (focus complémentaire: mesures, objets).
...
![Illustration - InstanSeg : générer et exploiter les mesures d'objets](https://commons.wikimedia.org/wiki/Special:FilePath/Cell-universe.jpg)
