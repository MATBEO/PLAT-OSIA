---
title: "Groovy : exporter toutes les mesures d'objets"
...
# Groovy : exporter toutes les mesures d'objets

## Portée précise
- Référence article: `groovy-export-mesures`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **groovy** (focus complémentaire: export, mesures).
...
![Illustration - Groovy : exporter toutes les mesures d'objets](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope3.jpg)
