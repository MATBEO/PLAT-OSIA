---
title: "Exporter les résultats de classification"
...
# Exporter les résultats de classification

## Portée précise
- Référence article: `pattern-export-resultats`
- Périmètre: la classification de structures tissulaires et l'interprétation du modèle.
- Axe technique dominant: **export** (focus complémentaire: pattern, resultats).
...
![Illustration - Exporter les résultats de classification](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope1.jpg)
...
- Documentation technique: [CSV format (RFC 4180)](https://datatracker.ietf.org/doc/html/rfc4180)
