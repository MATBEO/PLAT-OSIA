...
## Portée précise
- Référence article: `qupath-installation-propre`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **qupath** (focus complémentaire: installation, propre).
...
![Illustration - QuPath : installation propre et vérification initiale](https://qupath.github.io/assets/images/slideshow/qupath-jobs.png)
