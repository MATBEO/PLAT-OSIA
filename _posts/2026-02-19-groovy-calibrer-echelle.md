---
title: "Groovy : calibrer automatiquement l'échelle"
...
# Groovy : calibrer automatiquement l'échelle

## Portée précise
- Référence article: `groovy-calibrer-echelle`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **groovy** (focus complémentaire: calibrer, echelle).
...
![Illustration - Groovy : calibrer automatiquement l'échelle](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope1.jpg)
