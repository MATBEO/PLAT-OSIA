...
## Portée précise
- Référence article: `qupath-mesures-export-csv`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **qupath** (focus complémentaire: mesures, export, csv).
...
![Illustration - QuPath : exporter les mesures au format CSV](https://commons.wikimedia.org/wiki/Special:FilePath/Tissue_MicroArray_Slide.jpg)
