...
## Portée précise
- Référence article: `multiplex-controles-qualite`
- Périmètre: l'analyse multi-canaux et le phénotypage.
- Axe technique dominant: **multiplex** (focus complémentaire: controles, qualite).
...
![Illustration - Multiplex : check-list de contrôle qualité](https://commons.wikimedia.org/wiki/Special:FilePath/Tissue_MicroArray_Block.jpg)
