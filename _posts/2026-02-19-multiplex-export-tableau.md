---
title: "Multiplex : exporter un tableau de population"
...
# Multiplex : exporter un tableau de population

## Portée précise
- Référence article: `multiplex-export-tableau`
- Périmètre: l'analyse multi-canaux et le phénotypage.
- Axe technique dominant: **multiplex** (focus complémentaire: export, tableau).
...
![Illustration - Multiplex : exporter un tableau de population](https://commons.wikimedia.org/wiki/Special:FilePath/Microscope%20image.jpg)
