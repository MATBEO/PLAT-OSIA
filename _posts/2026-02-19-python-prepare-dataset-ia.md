---
title: "Python : préparer un dataset pour IA histologique"
...
# Python : préparer un dataset pour IA histologique

## Portée précise
- Référence article: `python-prepare-dataset-ia`
- Périmètre: la classification de structures tissulaires et l'interprétation du modèle.
- Axe technique dominant: **python** (focus complémentaire: prepare, dataset, ia).
