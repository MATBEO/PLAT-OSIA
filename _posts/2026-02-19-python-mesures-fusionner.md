---
title: "Python : fusionner des mesures multi-fichiers"
...
# Python : fusionner des mesures multi-fichiers

## Portée précise
- Référence article: `python-mesures-fusionner`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **python** (focus complémentaire: mesures, fusionner).
...
![Illustration - Python : fusionner des mesures multi-fichiers](https://qupath.github.io/assets/images/slideshow/qupath-youtube.png)
