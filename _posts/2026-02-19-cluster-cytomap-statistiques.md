---
title: "CytoMAP : lire les statistiques essentielles"
...
# CytoMAP : lire les statistiques essentielles

## Portée précise
- Référence article: `cluster-cytomap-statistiques`
- Périmètre: le clustering et l'analyse spatiale de populations.
- Axe technique dominant: **cytomap** (focus complémentaire: cluster, statistiques).
...
![Illustration - CytoMAP : lire les statistiques essentielles](https://commons.wikimedia.org/wiki/Special:FilePath/Dividing%20Cell%20Fluorescence.jpg)
