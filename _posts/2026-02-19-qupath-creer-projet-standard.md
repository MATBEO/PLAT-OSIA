...
## Portée précise
- Référence article: `qupath-creer-projet-standard`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **qupath** (focus complémentaire: creer, projet, standard).
...
![Illustration - QuPath : créer un projet standard reproductible](https://qupath.github.io/assets/images/slideshow/qupath-getting-started.png)
