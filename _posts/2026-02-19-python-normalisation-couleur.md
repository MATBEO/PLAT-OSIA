---
title: "Python : normalisation de couleur H&E"
...
# Python : normalisation de couleur H&E

## Portée précise
- Référence article: `python-normalisation-couleur`
- Périmètre: la classification de structures tissulaires et l'interprétation du modèle.
- Axe technique dominant: **python** (focus complémentaire: normalisation, couleur).
...
![Illustration - Python : normalisation de couleur H&E](https://commons.wikimedia.org/wiki/Special:FilePath/Histology.jpg)
