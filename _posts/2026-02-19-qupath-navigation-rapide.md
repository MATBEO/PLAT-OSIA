---
title: "QuPath : navigation rapide dans les WSI"
...
# QuPath : navigation rapide dans les WSI

## Portée précise
- Référence article: `qupath-navigation-rapide`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **qupath** (focus complémentaire: navigation, rapide).
...
![Illustration - QuPath : navigation rapide dans les WSI](https://commons.wikimedia.org/wiki/Special:FilePath/Histology.jpg)
