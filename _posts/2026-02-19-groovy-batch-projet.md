---
title: "Groovy : batch processing sur projet QuPath"
...
# Groovy : batch processing sur projet QuPath

## Portée précise
- Référence article: `groovy-batch-projet`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **groovy** (focus complémentaire: batch, projet).
...
![Illustration - Groovy : batch processing sur projet QuPath](https://commons.wikimedia.org/wiki/Special:FilePath/Tissue_MicroArray_Slide.jpg)
