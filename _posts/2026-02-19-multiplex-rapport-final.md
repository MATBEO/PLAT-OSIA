---
title: "Multiplex : construire un rapport final lisible"
...
# Multiplex : construire un rapport final lisible

## Portée précise
- Référence article: `multiplex-rapport-final`
- Périmètre: l'analyse multi-canaux et le phénotypage.
- Axe technique dominant: **multiplex** (focus complémentaire: rapport, final).
...
![Illustration - Multiplex : construire un rapport final lisible](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope1.jpg)
