...
## Portée précise
- Référence article: `stardist-vs-instanseg`
- Périmètre: la segmentation cellulaire et la quantification d'objets.
- Axe technique dominant: **instanseg** (focus complémentaire: stardist, vs).
...
![Illustration - StarDist vs InstanSeg : quand utiliser quoi](https://commons.wikimedia.org/wiki/Special:FilePath/Histology.jpg)
