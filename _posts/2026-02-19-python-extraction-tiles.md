...
## Portée précise
- Référence article: `python-extraction-tiles`
- Périmètre: l'exploration visuelle, l'organisation du projet et la fiabilité des exports.
- Axe technique dominant: **python** (focus complémentaire: extraction, tiles).
...
![Illustration - Python : extraction de tuiles depuis WSI](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope3.jpg)
