---
title: "CytoMAP : exporter des figures exploitables"
...
# CytoMAP : exporter des figures exploitables

## Portée précise
- Référence article: `cluster-cytomap-export-figures`
- Périmètre: le clustering et l'analyse spatiale de populations.
- Axe technique dominant: **cytomap** (focus complémentaire: cluster, export, figures).
...
![Illustration - CytoMAP : exporter des figures exploitables](https://qupath.github.io/assets/images/slideshow/qupath-jobs.png)
