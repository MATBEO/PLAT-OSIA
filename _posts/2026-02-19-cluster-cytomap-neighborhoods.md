...
## Portée précise
- Référence article: `cluster-cytomap-neighborhoods`
- Périmètre: le clustering et l'analyse spatiale de populations.
- Axe technique dominant: **cytomap** (focus complémentaire: cluster, neighborhoods).
...
![Illustration - CytoMAP : définir les neighborhoods](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope2.jpg)
