---
title: "Performance : prétraitement WSI à grande échelle"
...
# Performance : prétraitement WSI à grande échelle

## Portée précise
- Référence article: `perf-wsi-preprocessing`
- Périmètre: la classification de structures tissulaires et l'interprétation du modèle.
- Axe technique dominant: **perf** (focus complémentaire: wsi, preprocessing).
...
![Illustration - Performance : prétraitement WSI à grande échelle](https://qupath.github.io/assets/images/slideshow/qupath-jobs.png)
