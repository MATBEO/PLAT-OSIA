...
## Portée précise
- Référence article: `instanseg-parametres-cles`
- Périmètre: la segmentation cellulaire et la quantification d'objets.
- Axe technique dominant: **instanseg** (focus complémentaire: parametres, cles).
...
![Illustration - InstanSeg : paramètres clés à connaître](https://commons.wikimedia.org/wiki/Special:FilePath/Fluorescence.microscope2.jpg)
